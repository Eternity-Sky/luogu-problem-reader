# P2687 P2687 [USACO4.3] 逢低吸纳 Buy Low, Buy Lower

## 题目背景

本题可以使用 `long double` 通过是刻意的。加强版请到 [P12930](https://www.luogu.com.cn/problem/P12930)。在本题中，$N\leq 5000$。
...
以后多行，输入 $N$ 个正整数（可能分多行），第 $i$ 个正整数表示第 $i$ 天的股价。这些正整数大小不会超过 $2^{31}-1$。
